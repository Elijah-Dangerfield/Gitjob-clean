...
fun BottomNavigationView.setupWithNavController(
    ...
    navGraphIds.forEachIndexed { index, navGraphId ->
        ...
        //hides bottom navigation if any of the hosts navigates to a fragment that
        // is a FullScreenView
        navHostFragment.childFragmentManager.addOnBackStackChangedListener {
            navHostFragment.childFragmentManager.fragments.firstOrNull()?.let {
                val bottomNav = findViewById<BottomNavigationView>(R.id.bottom_nav)
                bottomNav.goneIf(it is FullScreenFragment)
            }
        }
...
private fun BottomNavigationView.setupItemReselected(
    ...
    setOnNavigationItemReselectedListener { item ->
        ...
        if (selectedFragment.navController.currentDestination?.id == navController.graph.startDestination) {
            selectedFragment.childFragmentManager.fragments.firstOrNull()?.let {
                (it as? BottomNavReselectHandler)?.handleReselectedAtStart()
            }
        }
